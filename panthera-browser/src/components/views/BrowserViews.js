...
// ==========================================
export const HomePage = ({ theme, handleSearch, isLoading, shortcuts, setCurrentView, setAddressBar }) => (
...
// PROFILE VIEW
// ==========================================
export const ProfileView = ({ profile, theme, darkMode, openMessageModal, copyToClipboard, copiedKey, fetchProfile }) => {
...
// SEARCH RESULTS VIEW
// ==========================================
export const SearchResultsView = ({ searchResults, theme, addressBar, fetchProfile, goHome }) => (
...
// NOT FOUND VIEW
// ==========================================
export const NotFoundView = ({ theme, addressBar, error, goHome }) => (
