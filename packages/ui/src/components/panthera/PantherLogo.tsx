// ═══════════════════════════════════════════════════════════════════
// PANTHERA v2 — Logo SVG Component
// ═══════════════════════════════════════════════════════════════════
// Location: packages/ui/src/components/panthera/PantherLogo.tsx
// ═══════════════════════════════════════════════════════════════════
...
export default function PantherLogo({ size = 64, className = '' }: PantherLogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" className={className}>
      <defs>
        <linearGradient id="furG" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        <radialGradient id="eyeS" cx="30%" cy="30%" r="50%">
          <stop offset="0%" stopColor="#fff" stopOpacity="0.8" />
          <stop offset="100%" stopColor="#fff" stopOpacity="0" />
        </radialGradient>
      </defs>
      {/* Head */}
      <path d="M100 25 C 45 25, 20 70, 25 110 C 28 140, 45 170, 100 180 C 155 170, 172 140, 175 110 C 180 70, 155 25, 100 25 Z" fill="url(#furG)" />
      {/* Left ear */}
      ...
      <ellipse cx="65" cy="95" rx="16" ry="14" fill="url(#eyeG)" />
      <ellipse cx="65" cy="95" rx="7" ry="12" fill="#0d0d0d" />
      <ellipse cx="62" cy="92" rx="4" ry="3" fill="url(#eyeS)" />
      <ellipse cx="135" cy="95" rx="16" ry="14" fill="url(#eyeG)" />
      <ellipse cx="135" cy="95" rx="7" ry="12" fill="#0d0d0d" />
      <ellipse cx="132" cy="92" rx="4" ry="3" fill="url(#eyeS)" />
      {/* Nose bridge & muzzle */}
